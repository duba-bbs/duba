...
import com.tingyu.duba.system.api.factory.RemoteLogFallbackFactory;
...
public interface RemoteLogService {
    ...
    R<Boolean> saveLoginInfo(@RequestParam("username") String username, @RequestParam("status") String status,
