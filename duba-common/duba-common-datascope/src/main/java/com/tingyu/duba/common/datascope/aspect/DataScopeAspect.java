package com.tingyu.duba.common.datascope.aspect;
...
import com.tingyu.duba.common.datascope.annotation.DataScope;
...
public class DataScopeAspect {
    ...
    protected void handleDataScope(final JoinPoint joinPoint) {
        ...
        if (StringUtils.isNotNull(loginUser)) {
            ...
            // 如果是超级管理员，则不过滤数据
            if (StringUtils.isNotNull(currentUser) && !UserType.ADMIN.getCode().equals(currentUser.getUserType())) {
